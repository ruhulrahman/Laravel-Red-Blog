          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  {!! Form::open(['url' => 'admin/user_register', 'method' => 'post']) !!}
                  <form id="register-form">
                    <div class="form-group">
                      <input id="register-username" type="text" name="admin_name" required class="input-material">
                  ...
                  {!! Form::open() !!}
                  <small>Already have an account? </small><a href="{{ URL::to('admin/login') }}" class="signup">Login</a>
                </div>
              </div>
            </div>
          </div>
